      ...
      <ng-template #body>
        <div class="container col-xl-10 col-lg-10 col-sm-9 col-md-9 col-sm-12 col-12"
          ...
          <div *ngIf="(deviceState.isSmallScreen | async) === false" class="d-flex flex-wrap">
            <app-libs-rbac [groups]="['admin']" [pagePath]="page.path"
                           *ngFor="let page of reportPages" routerLink="{{page.path}}">
              <ng-template>
                <div style="margin: 8px; cursor: pointer">
                  <mat-card matRipple
                    ...
                    <mat-icon color="primary" style="font-size: 60px; height: 60px; width: 60px">
                      ...
                      <svg *ngIf="page.name === 'Sales Growth'" width="60" height="56" viewBox="0 0 488 412" fill="none"
          ...
          <div *ngIf="(deviceState.isSmallScreen | async) === true">
            <mat-nav-list>
              <app-libs-rbac [groups]="['admin']" [pagePath]="page.path" *ngFor="let page of reportPages">
                <ng-template>
