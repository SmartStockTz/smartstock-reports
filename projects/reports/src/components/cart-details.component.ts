    ...
    <div class="w-100 m-0 p-0">
      ...
      <div class="d-flex justify-content-end" style="margin-bottom: 24px">
        ...
        <button
          ...
          mat-flat-button
          (click)="printReceiptOverview(data)"
        >
          Print Receipt Overview
        </button>
      </div>
      <hr class="my-0" />
      ...
      <div class="py-3">
        <table mat-table [dataSource]="cartData" matSort>
          ...
          <tr
            ...
            mat-row
            *matRowDef="let row; columns: cartDataColumns"
          ></tr>
        </table>
        <mat-paginator
          *ngIf="cartData.data.length > 5"
        ...
        <div class="d-flex pt-4 align-items-center justify-content-between">
          ...
          <h2
            class="text-white py-3 col-7 col-md-5 col-lg-6 text-center"
...
export class CartDetailsComponent implements OnInit {
  ...
  constructor(
    private cartDetailsSheetRef: MatBottomSheetRef<CartDetailsComponent>,
