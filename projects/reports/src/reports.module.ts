...
const routes: Routes = [
  ...
  {
    path: "sales/overview/invoice/day",
    component: InvoiceSalesOverviewDayPage
  },
  {
    path: "sales/overview/invoice/month",
    component: InvoiceSalesOverviewMonthPage
  },
  {
    path: "sales/overview/invoice/year",
    component: InvoiceSalesOverviewYearPage
  },
  { path: "sales/track/cash", component: CashSalesTrackPage },
  {
    path: "sales/performance/product",
    component: CashSalesPerformanceProductPage
  },
  {
    path: "sales/performance/seller",
    component: CashSalesPerformanceSellerPage
  },
  {
    path: "sales/performance/category",
    component: CashSalesPerformanceCategoryPage
  }
];
